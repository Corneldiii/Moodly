...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-200 via-purple-200 to-pink-200 flex items-center justify-center p-4 md:p-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-125 h-125 rounded-full bg-cyan-400/40 blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-125 h-125 rounded-full bg-amber-300/40 blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md bg-white/60 backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-10 border border-white/60 shadow-2xl shadow-purple-500/20 relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm font-bold text-slate-500">Mulai perjalanan self-awareness kamu</p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="text-xs font-black text-slate-500 mb-2 block uppercase tracking-widest ml-2">Nama Panggilan</label>
            <input
              type="text"
              value={name}
        ...
        <p className="text-center text-sm font-medium text-slate-500 mt-8">
          Sudah punya akun?{' '}
          <Link href="/login" className="text-violet-600 font-black hover:text-pink-600 transition-colors">
            Masuk di sini
          </Link>
        </p>
      </div>
